                                                ...
                                                <div x-show="openReturn" @click.outside="openReturn = false"
                                                    ...
                                                    <form wire:submit.prevent="returnToTech" class="w-80">
                                                        <textarea wire:model.defer="reasonForReturn" rows="4" placeholder="Envía un comentario...🚀"
                                                            class="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" required></textarea>
                                                        <button type="submit"
                                                                    ...
                                                                    <div x-data="{ open: false }">
                                                                        <button @click="open = !open"
                                                                            ...
                                                                            <img src="{{ asset('images/noteDoc.svg') }}"
                                                                                width="14">
                                                                            <span
                                                                                class="pl-1 text-[9px] text-gray-400">LECTURA
                                                                            </span>
                                                                        </button>
                                                                        <div x-show="open"
                                                        ...
                                                        <h2>
                                                            <button wire:click="toggleParent"
                                                                ...
                                                                <div class="flex flex-col w-90">
                                                                    <span class="text-xs font-medium">MIS
                                                                        PLANTILLAS</span>
                                                                    <span
                                                                        class="text-xs font-light text-neutral-400">{{ Auth::user()->name }}</span>
                                                                </div>
