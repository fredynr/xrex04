                        ...
                        <div class="relative mt-6 px-1 w-full">
                            <div class="flex flex-col items-center justify-center w-full">
                                <div class="w-80">
                                    ...
                                    rows="4" disabled >{{ $estudio->reading ?? 'No hay lectura' }}</textarea>
                                </div>
                            </div>
                            <div class="flex flex-col items-center justify-center w-full">
                                <form wire:submit.prevent="insertAddendum" class="w-80">
                                    <label for="addendum" class="block mb-2 text-sm font-medium text-gray-900">
                                        Insertar Addendum
                                    </label>
                                    <textarea wire:model="addendum" id="addendum" rows="4"
                                        class="p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                        placeholder="Escribe addendum aquí..."></textarea>
                                    <button type="submit"
