    ...
    <table class="min-w-full divide-y divide-neutral-200/70">
        ...
        <tbody class="divide-y divide-neutral-200/70">
            @foreach ($estudios as $estudio)
                <tr class="text-neutral-600 text-xs bg-neutral-50 hover:bg-slate-200" wire:key="study-{{ $estudio->id }}">
                    ...
                    <td class="max-w-40 px-5 overflow-hidden text-ellipsis whitespace-nowrap truncate">{{ $estudio->study_state }}</td>
