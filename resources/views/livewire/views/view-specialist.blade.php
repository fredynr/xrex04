<div x-data="{
    ...
    showEstado: JSON.parse(localStorage.getItem('showEstado')) || false,
...
$watch('showProcedencia', value => localStorage.setItem('showProcedenciaState', JSON.stringify(value)));">
        ...
        <tbody class="divide-y divide-neutral-200/70">
            @foreach ($estudios as $estudio)
                <tr class="text-neutral-600 text-xs bg-neutral-50 hover:bg-slate-200"
                    ...
                    <td x-show="showEstado" class="max-w-40 px-5 overflow-hidden text-ellipsis whitespace-nowrap truncate">
