...
<head>
    ...
    <style>
        ...
        .watermark {
            ...
            /* Asegurar que se muestre en todas las páginas, si usas @page */
            /* margin-top: 50%; /* Alternativa si la rotación no funciona */
        }
...
<body class="">
    ...
    <div id="html_footer">
        <div class="bold">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/signatures/1.png'))) }}"
                style="display: block; margin: 0; padding: 0;">
            <div style="margin:8px 0;">{{ auth()->user()->name }}</div>
            <div>Tarjeta Nro. #########</div>
    ...
    <main>
        ...
        <div class="description">{!! nl2br(e($reading)) !!}</div>
